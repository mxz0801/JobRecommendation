...
import com.example.job.entity.ExtractRequestBody;
import com.example.job.entity.ExtractResponseItem;
import com.example.job.entity.Extraction;
    ...
    public List<Set<String>> extract(List<String> articles)
    {
        ...
        ResponseHandler<List<Set<String>>> responseHandler = response -> {
            ...
            for(ExtractResponseItem result :results)
            {
                ...
                {
                    keywords.add(extraction.parsedValue);  // parsedValue is key word from API
                }
